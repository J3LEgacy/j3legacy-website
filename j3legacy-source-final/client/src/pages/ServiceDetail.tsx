    ...
    <div className="min-h-screen">
        ...
        <div className="container">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            <div>
              ...
              <a href="#contact" onClick={scrollToContact} className="fade-up delay-100 btn-cta cursor-pointer">
      ...
      <section className="py-16 lg:py-20" style={{ background: "linear-gradient(135deg, #0B2545 0%, #132f55 100%)" }}>
        <div className="container text-center">
          ...
          <a href="#contact" onClick={scrollToContact} className="fade-up delay-200 btn-cta text-lg cursor-pointer">
            {service.cta} <ArrowRight size={18} />
          </a>
        </div>
      </section>
