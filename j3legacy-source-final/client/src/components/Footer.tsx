 ...
 * Note: Uses hash-based links (#/services/...) for GitHub Pages compatibility
 */
                ...
                <li key={link.href}>
                  {link.href.startsWith("#/") ? (
                    ...
                    <a
                      ...
                      className="text-white/50 hover:text-white text-sm transition-colors no-underline cursor-pointer"
                    >
                      {link.label}
                    </a>
                  )}
